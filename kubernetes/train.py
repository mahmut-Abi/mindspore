...
# context.set_context(runtime_num_threads=4)
...
trainer.fit(epoch=10, train_dataset=train_dataset, valid_dataset=test_dataset, callbacks=[ckpt_callback, loss_callback], initial_epoch=0)
